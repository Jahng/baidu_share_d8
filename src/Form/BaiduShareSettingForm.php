...
class BaiduShareSettingForm extends ConfigFormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['common'] = array(
      '#type' => 'fieldset',
      '#title' => SafeMarkup::format('@label', array('@label' => $this->t('通用设置'))),
      '#tree' => TRUE,
    );
    //common setting
    ...
    $form['share_button'] = array(
      '#type' => 'fieldset',
      '#title' => SafeMarkup::format('@label', array('@label' => $this->t('分享按钮设置'))),
      '#tree' => TRUE,
    );
    ...
    $form['slide'] = array(
      '#type' => 'fieldset',
      '#title' => SafeMarkup::format('@label', array('@label' => $this->t('浮窗分享设置'))),
      '#tree' => TRUE,
    );
    ...
    $form['share_image'] = array(
      '#type' => 'fieldset',
      '#title' => SafeMarkup::format('@label', array('@label' => $this->t('图片分享设置'))),
      '#tree' => TRUE,
    );
    $this->_setShareImageForm($form['share_image'], $config);

    // select share setting
    $form['select_share'] = array(
      '#type' => 'fieldset',
      '#title' => SafeMarkup::format('@label', array('@label' => $this->t('划词分享设置'))),
      '#tree' => TRUE,
    );
...
cmd为分享目标id，config为当前设置，返回值为更新后的设置。'),
    ...
    $form['show_count'] = array(
      ...
      '#options' => array($this->t('不显示'), $this->t('显示'))
    );
    $form['list'] = array(
      '#type' => 'textarea',
      '#title' => $this->t('list'),
